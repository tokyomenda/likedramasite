  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mb-5 flex items-end justify-between gap-4">
        ...
        <a
          className="hidden rounded-full border border-white/10 px-4 py-2 text-sm font-semibold text-zinc-300 transition hover:border-orange-400/50 hover:text-white sm:inline-flex"
          href="#"
        >
          Бүгдийг үзэх
        </a>
